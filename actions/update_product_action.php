...
try {
    ...
    // if image is empty, keep the old image
    ...
    // update product
    $result = update_product_ctr($product_id, $cat_id, $brand_id, $product_title, $product_price, $product_desc, $product_image, $product_keywords, $user_id);
